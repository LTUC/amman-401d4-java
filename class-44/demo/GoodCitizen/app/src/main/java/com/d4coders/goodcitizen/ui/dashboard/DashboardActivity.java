...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPref = getSharedPreferences(AuthActivity.USER_DATA, Context.MODE_PRIVATE);

        int calculatedPoints = sharedPref.getInt(PointsManager.USER_CREDIT, 0);
        String nationalId = sharedPref.getString(AuthActivity.USER_NATIONAL_ID, "928393492239423");
        String username = sharedPref.getString(AuthActivity.USER_NAME, "John Doe");
        String number = sharedPref.getString(AuthActivity.USER_NUMBER, "962-555-5555");
        String email = sharedPref.getString(AuthActivity.USER_EMAIL, "john.doe@gmail.com");

        TextView usernameTV = findViewById(R.id.textView_username);
        TextView natIdTV = findViewById(R.id.textView_national_id_no);
        TextView numberTV = findViewById(R.id.textView_phone_no);
        TextView credits = findViewById(R.id.textView_social_credits);

        credits.setText(String.format(Integer.toString(calculatedPoints), Locale.ENGLISH));
        usernameTV.setText(username);
        natIdTV.setText(nationalId);
        ...
        fab.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(getApplicationContext(), ObservationCreationActivity.class);
            ActivityOptions options = ActivityOptions
                    .makeSceneTransitionAnimation(this, fab, "robot");
