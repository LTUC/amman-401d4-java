...
public class SignInFragment extends Fragment {
    ...
    private OnSignInComplete signInCompleteListener;
    ...
    private void signIn(String email, String password) {
        Amplify.Auth.signIn(
                ...
                password,
                result -> {
                    signInCompleteListener.signInCompleted();
    ...
    public void setSignInListener(SignInFragment.OnSignInComplete listener) {
        signInCompleteListener = listener;
    }
