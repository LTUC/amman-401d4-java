...
public final class User implements Model {
  ...
  public static final QueryField CREDITS = field("User", "credits");
  ...
  private final @ModelField(targetType="Int") Integer credits;
  ...
  private User(String id, String firstName, String lastName, String nationalID, String email, String number, Integer credits) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getCredits(), user.getCredits()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String firstName, String lastName, String nationalId, String email, String number, Integer credits) {
      super.id(id);
